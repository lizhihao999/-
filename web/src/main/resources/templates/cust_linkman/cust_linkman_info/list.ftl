    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="cust_linkman:cust_linkman_info:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="cust_linkman:cust_linkman_info:add">
                    ...
                    <script type="text/html" id="List-editBar">
                        <@sec.authenticate grants="cust_linkman:cust_linkman_info:update">
                            <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="update"><i
                                        class="layui-icon">&#xe642;</i>修改</a>
                        </@sec.authenticate>
                        <@sec.authenticate grants="cust_linkman:cust_linkman_info:delete">
...
<script type="text/javascript" src="${request.contextPath}/scripts/cust_linkman/cust_linkman_info/list.js?_=${randomNum}"></script>
</body>
</html>

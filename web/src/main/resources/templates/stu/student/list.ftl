    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="stu:student:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="stu:student:add">
...
<script type="text/javascript" src="${request.contextPath}/scripts/stu/student/list.js?_=${randomNum}"></script>
</body>
</html>
